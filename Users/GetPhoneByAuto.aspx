...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    <title>Узнать телефон владельца автомобиля
    </title>
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentNav" runat="Server">
    ...
    <li class="nav-item dropdown">
        ...
        <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
            <li><a class="dropdown-item active" aria-current="page" href="#">Получить телефон владельца авто</a></li>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="card" style="max-width: 23rem;margin: 75px auto;">
        <div class="card-header">
            Получение номера телефона владельца автомобиля
        </div>
        <ul class="list-group list-group-flush">
            ...
            <li class="list-group-item"><asp:TextBox ID="txt_auto" placeholder="a000aa99" runat="server" 
                ...
                CssClass="w-100" /></li>
            <li class="list-group-item"><asp:Button Text="Номер телефона владельца" runat="server" CssClass="btn btn-primary w-100" ID="btn_getPhone" OnClick="GetPhone_Click" /></li>
